...
with(this){return _c('h3',{attrs:{"id":"edit-contact-by-index-name"}},[_v("Edit contact by Index/Name"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#edit-contact-by-index-name","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"proposed-creating-and-deleting-tag-objects"}},[_v("[Proposed] Creating and Deleting Tag Objects"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-creating-and-deleting-tag-objects","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ctag")]),_v(": Creates a Tag object that will be stored in a global Tag array within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ModelManager")]),_v(" class.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("dtag")]),_v(": Deletes a Tag object that is currently stored in the global Tag array within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ModelManager")]),_v(" class. This\nwill also delete all instances of the Tag object within the program.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Each Tag object that exists in the program must exist within this global Tag array. Existing functions such as\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" will support the creation of Tag objects to be added to this global Tag array.")])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"delete-event-command"}},[_v("Delete Event Command"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#delete-event-command","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"proposed-importing-and-exporting-as-csv-file"}},[_v("[Proposed] Importing and Exporting as .csv file"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-importing-and-exporting-as-csv-file","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 15 Apr 2024, 15:53:39 GMT+8]")])])])}
}];
