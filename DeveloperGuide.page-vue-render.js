...
with(this){return _c('h3',{attrs:{"id":"proposed-event-switching-feature"}},[_v("[Proposed] Event switching feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-event-switching-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Filtering Mechanism: filters contacts in the EventBook based on event tag, allowing for selective display of contacts based on event tag.")]),_v(" "),_c('li',[_v("UI enhancements: allow users to see each event as a tab and after navigating to a particular tab, they will be able to view contacts of members under that event.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The user launches the application. The application will be in its initial state showing the full list of contacts in the EventBook.")]),_v(" "),_c('li',[_v("The user switches tabs to a particular event by executing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("switch eventTagName")]),_v(". The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filteredPersons")]),_v(" list in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" class will be updated and user will be able to see all contacts of members under this event.")]),_v(" "),_c('li',[_v("User can further filter contacts by executing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search tagName")]),_v(". This displays users in this event with the specified tag.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sun, 14 Apr 2024, 21:49:14 GMT+8]")])])])}
}];
